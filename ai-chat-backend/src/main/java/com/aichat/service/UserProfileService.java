...
public class UserProfileService {
    ...
    public void createDefaultProfiles() {
        ...
        createProfileIfNotExists(
            "Junior Developer",
            "Ты опытный наставник. Объясняй всё подробно, шаг за шагом. Приводи примеры кода. Разбирай каждую концепцию детально. Отвечай на русском языке.",
            "ru",
            "detailed",
        ...
        createProfileIfNotExists(
            "Senior Developer",
            "Ты старший разработчик. Отвечай кратко и по существу. Фокусируйся на ключевых моментах. Избегай излишних деталей. Отвечай на русском языке.",
            "ru",
            "concise",
