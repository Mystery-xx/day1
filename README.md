...
**Интерактивный чат с ИИ-моделями** через OpenAI-совместимый API с поддержкой MCP (Model Context Protocol) для вызова инструментов. **Предназначен для обучения работе с ИИ** — позволяет на практике освоить взаимодействие с языковыми моделями, MCP-инструментами и RAG-технологиями.
